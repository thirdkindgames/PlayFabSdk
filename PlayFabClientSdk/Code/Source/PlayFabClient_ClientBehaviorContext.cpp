...
#include "StdAfx.h"
#include "PlayFabClient_ClientBehaviorContext.h"
#include <AzCore/RTTI/ReflectContext.h>
#include <AzCore/RTTI/BehaviorContext.h>

#include "PlayFabClientSdk/PlayFabClient_ClientNotificationBus.h"
#include "PlayFabClientSdk/PlayFabClient_ClientBus.h"
#include "PlayFabClientSdk/PlayFabClientDataModels.h"

#include "PlayFabClient_OnDemandReflection.inl"
...
namespace PlayFabClientSdk
{
    ...
    template<typename T>
    class PlayFabClient_ClientBehaviorBusBaseHandler : 
    ...
    protected:
        ...
        // Constructor
        PlayFabClient_ClientBehaviorBusBaseHandler()
        {
	...
	class PlayFabClient_ClientBehaviorBusHandler : 
		public PlayFabClient_ClientNotificationBus::Handler, 
		public PlayFabClient_ClientBehaviorBusBaseHandler<PlayFabClient_ClientBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabClient_ClientBehaviorBusHandler,"{f7af5120-cf58-523e-80ee-7040a26244b5}",AZ::BehaviorEBusHandler)
	...
	class PlayFabClient_ClientGlobalBehaviorBusHandler : 
		public PlayFabClient_ClientGlobalNotificationBus::Handler, 
		public PlayFabClient_ClientBehaviorBusBaseHandler<PlayFabClient_ClientGlobalBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabClient_ClientGlobalBehaviorBusHandler,"{7e81315c-06d9-5eea-be9c-11c8bb28e93d}",AZ::BehaviorEBusHandler)
    ...
    //-----------------------------------------------------------------------------------------------------
	void PlayFabClient_ClientBehaviorContext::Reflect(AZ::ReflectContext* context)
	{
		AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context);
		if (behaviorContext)
		{
			// Reflect the request bus
			behaviorContext->EBus<PlayFabClient_ClientSimpleRequestBus>("PlayFabClientRequestBus")
				->Event("GetPhotonAuthenticationToken", &PlayFabClient_ClientSimpleRequestBus::Events::GetPhotonAuthenticationToken)
				->Event("GetTitlePublicKey", &PlayFabClient_ClientSimpleRequestBus::Events::GetTitlePublicKey)
				->Event("GetWindowsHelloChallenge", &PlayFabClient_ClientSimpleRequestBus::Events::GetWindowsHelloChallenge)
				->Event("LoginWithAndroidDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithAndroidDeviceID)
				->Event("LoginWithCustomID", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithCustomID)
				->Event("LoginWithEmailAddress", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithEmailAddress)
				->Event("LoginWithFacebook", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithFacebook)
				->Event("LoginWithGameCenter", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithGameCenter)
				->Event("LoginWithGoogleAccount", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithGoogleAccount)
				->Event("LoginWithIOSDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithIOSDeviceID)
				->Event("LoginWithKongregate", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithKongregate)
				->Event("LoginWithPlayFab", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithPlayFab)
				->Event("LoginWithSteam", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithSteam)
				->Event("LoginWithTwitch", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithTwitch)
				->Event("LoginWithWindowsHello", &PlayFabClient_ClientSimpleRequestBus::Events::LoginWithWindowsHello)
				->Event("RegisterPlayFabUser", &PlayFabClient_ClientSimpleRequestBus::Events::RegisterPlayFabUser)
				->Event("RegisterWithWindowsHello", &PlayFabClient_ClientSimpleRequestBus::Events::RegisterWithWindowsHello)
				->Event("SetPlayerSecret", &PlayFabClient_ClientSimpleRequestBus::Events::SetPlayerSecret)
				->Event("AddGenericID", &PlayFabClient_ClientSimpleRequestBus::Events::AddGenericID)
				->Event("AddUsernamePassword", &PlayFabClient_ClientSimpleRequestBus::Events::AddUsernamePassword)
				->Event("GetAccountInfo", &PlayFabClient_ClientSimpleRequestBus::Events::GetAccountInfo)
				->Event("GetPlayerCombinedInfo", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerCombinedInfo)
				->Event("GetPlayerProfile", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerProfile)
				->Event("GetPlayFabIDsFromFacebookIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromFacebookIDs)
				->Event("GetPlayFabIDsFromGameCenterIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromGameCenterIDs)
				->Event("GetPlayFabIDsFromGenericIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromGenericIDs)
				->Event("GetPlayFabIDsFromGoogleIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromGoogleIDs)
				->Event("GetPlayFabIDsFromKongregateIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromKongregateIDs)
				->Event("GetPlayFabIDsFromSteamIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromSteamIDs)
				->Event("GetPlayFabIDsFromTwitchIDs", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayFabIDsFromTwitchIDs)
				->Event("LinkAndroidDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::LinkAndroidDeviceID)
				->Event("LinkCustomID", &PlayFabClient_ClientSimpleRequestBus::Events::LinkCustomID)
				->Event("LinkFacebookAccount", &PlayFabClient_ClientSimpleRequestBus::Events::LinkFacebookAccount)
				->Event("LinkGameCenterAccount", &PlayFabClient_ClientSimpleRequestBus::Events::LinkGameCenterAccount)
				->Event("LinkGoogleAccount", &PlayFabClient_ClientSimpleRequestBus::Events::LinkGoogleAccount)
				->Event("LinkIOSDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::LinkIOSDeviceID)
				->Event("LinkKongregate", &PlayFabClient_ClientSimpleRequestBus::Events::LinkKongregate)
				->Event("LinkSteamAccount", &PlayFabClient_ClientSimpleRequestBus::Events::LinkSteamAccount)
				->Event("LinkTwitch", &PlayFabClient_ClientSimpleRequestBus::Events::LinkTwitch)
				->Event("LinkWindowsHello", &PlayFabClient_ClientSimpleRequestBus::Events::LinkWindowsHello)
				->Event("RemoveGenericID", &PlayFabClient_ClientSimpleRequestBus::Events::RemoveGenericID)
				->Event("ReportPlayer", &PlayFabClient_ClientSimpleRequestBus::Events::ReportPlayer)
				->Event("SendAccountRecoveryEmail", &PlayFabClient_ClientSimpleRequestBus::Events::SendAccountRecoveryEmail)
				->Event("UnlinkAndroidDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkAndroidDeviceID)
				->Event("UnlinkCustomID", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkCustomID)
				->Event("UnlinkFacebookAccount", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkFacebookAccount)
				->Event("UnlinkGameCenterAccount", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkGameCenterAccount)
				->Event("UnlinkGoogleAccount", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkGoogleAccount)
				->Event("UnlinkIOSDeviceID", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkIOSDeviceID)
				->Event("UnlinkKongregate", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkKongregate)
				->Event("UnlinkSteamAccount", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkSteamAccount)
				->Event("UnlinkTwitch", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkTwitch)
				->Event("UnlinkWindowsHello", &PlayFabClient_ClientSimpleRequestBus::Events::UnlinkWindowsHello)
				->Event("UpdateAvatarUrl", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateAvatarUrl)
				->Event("UpdateUserTitleDisplayName", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateUserTitleDisplayName)
				->Event("GetFriendLeaderboard", &PlayFabClient_ClientSimpleRequestBus::Events::GetFriendLeaderboard)
				->Event("GetFriendLeaderboardAroundPlayer", &PlayFabClient_ClientSimpleRequestBus::Events::GetFriendLeaderboardAroundPlayer)
				->Event("GetLeaderboard", &PlayFabClient_ClientSimpleRequestBus::Events::GetLeaderboard)
				->Event("GetLeaderboardAroundPlayer", &PlayFabClient_ClientSimpleRequestBus::Events::GetLeaderboardAroundPlayer)
				->Event("GetPlayerStatistics", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerStatistics)
				->Event("GetPlayerStatisticVersions", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerStatisticVersions)
				->Event("GetUserData", &PlayFabClient_ClientSimpleRequestBus::Events::GetUserData)
				->Event("GetUserPublisherData", &PlayFabClient_ClientSimpleRequestBus::Events::GetUserPublisherData)
				->Event("GetUserPublisherReadOnlyData", &PlayFabClient_ClientSimpleRequestBus::Events::GetUserPublisherReadOnlyData)
				->Event("GetUserReadOnlyData", &PlayFabClient_ClientSimpleRequestBus::Events::GetUserReadOnlyData)
				->Event("UpdatePlayerStatistics", &PlayFabClient_ClientSimpleRequestBus::Events::UpdatePlayerStatistics)
				->Event("UpdateUserData", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateUserData)
				->Event("UpdateUserPublisherData", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateUserPublisherData)
				->Event("GetCatalogItems", &PlayFabClient_ClientSimpleRequestBus::Events::GetCatalogItems)
				->Event("GetPublisherData", &PlayFabClient_ClientSimpleRequestBus::Events::GetPublisherData)
				->Event("GetStoreItems", &PlayFabClient_ClientSimpleRequestBus::Events::GetStoreItems)
				->Event("GetTime", &PlayFabClient_ClientSimpleRequestBus::Events::GetTime)
				->Event("GetTitleData", &PlayFabClient_ClientSimpleRequestBus::Events::GetTitleData)
				->Event("GetTitleNews", &PlayFabClient_ClientSimpleRequestBus::Events::GetTitleNews)
				->Event("AddUserVirtualCurrency", &PlayFabClient_ClientSimpleRequestBus::Events::AddUserVirtualCurrency)
				->Event("ConfirmPurchase", &PlayFabClient_ClientSimpleRequestBus::Events::ConfirmPurchase)
				->Event("ConsumeItem", &PlayFabClient_ClientSimpleRequestBus::Events::ConsumeItem)
				->Event("GetCharacterInventory", &PlayFabClient_ClientSimpleRequestBus::Events::GetCharacterInventory)
				->Event("GetPurchase", &PlayFabClient_ClientSimpleRequestBus::Events::GetPurchase)
				->Event("GetUserInventory", &PlayFabClient_ClientSimpleRequestBus::Events::GetUserInventory)
				->Event("PayForPurchase", &PlayFabClient_ClientSimpleRequestBus::Events::PayForPurchase)
				->Event("PurchaseItem", &PlayFabClient_ClientSimpleRequestBus::Events::PurchaseItem)
				->Event("RedeemCoupon", &PlayFabClient_ClientSimpleRequestBus::Events::RedeemCoupon)
				->Event("StartPurchase", &PlayFabClient_ClientSimpleRequestBus::Events::StartPurchase)
				->Event("SubtractUserVirtualCurrency", &PlayFabClient_ClientSimpleRequestBus::Events::SubtractUserVirtualCurrency)
				->Event("UnlockContainerInstance", &PlayFabClient_ClientSimpleRequestBus::Events::UnlockContainerInstance)
				->Event("UnlockContainerItem", &PlayFabClient_ClientSimpleRequestBus::Events::UnlockContainerItem)
				->Event("AddFriend", &PlayFabClient_ClientSimpleRequestBus::Events::AddFriend)
				->Event("GetFriendsList", &PlayFabClient_ClientSimpleRequestBus::Events::GetFriendsList)
				->Event("RemoveFriend", &PlayFabClient_ClientSimpleRequestBus::Events::RemoveFriend)
				->Event("SetFriendTags", &PlayFabClient_ClientSimpleRequestBus::Events::SetFriendTags)
				->Event("GetCurrentGames", &PlayFabClient_ClientSimpleRequestBus::Events::GetCurrentGames)
				->Event("GetGameServerRegions", &PlayFabClient_ClientSimpleRequestBus::Events::GetGameServerRegions)
				->Event("Matchmake", &PlayFabClient_ClientSimpleRequestBus::Events::Matchmake)
				->Event("StartGame", &PlayFabClient_ClientSimpleRequestBus::Events::StartGame)
				->Event("WriteCharacterEvent", &PlayFabClient_ClientSimpleRequestBus::Events::WriteCharacterEvent)
				->Event("WritePlayerEvent", &PlayFabClient_ClientSimpleRequestBus::Events::WritePlayerEvent)
				->Event("WriteTitleEvent", &PlayFabClient_ClientSimpleRequestBus::Events::WriteTitleEvent)
				->Event("AddSharedGroupMembers", &PlayFabClient_ClientSimpleRequestBus::Events::AddSharedGroupMembers)
				->Event("CreateSharedGroup", &PlayFabClient_ClientSimpleRequestBus::Events::CreateSharedGroup)
				->Event("GetSharedGroupData", &PlayFabClient_ClientSimpleRequestBus::Events::GetSharedGroupData)
				->Event("RemoveSharedGroupMembers", &PlayFabClient_ClientSimpleRequestBus::Events::RemoveSharedGroupMembers)
				->Event("UpdateSharedGroupData", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateSharedGroupData)
				->Event("ExecuteCloudScript", &PlayFabClient_ClientSimpleRequestBus::Events::ExecuteCloudScript)
				->Event("GetContentDownloadUrl", &PlayFabClient_ClientSimpleRequestBus::Events::GetContentDownloadUrl)
				->Event("GetAllUsersCharacters", &PlayFabClient_ClientSimpleRequestBus::Events::GetAllUsersCharacters)
				->Event("GetCharacterLeaderboard", &PlayFabClient_ClientSimpleRequestBus::Events::GetCharacterLeaderboard)
				->Event("GetCharacterStatistics", &PlayFabClient_ClientSimpleRequestBus::Events::GetCharacterStatistics)
				->Event("GetLeaderboardAroundCharacter", &PlayFabClient_ClientSimpleRequestBus::Events::GetLeaderboardAroundCharacter)
				->Event("GetLeaderboardForUserCharacters", &PlayFabClient_ClientSimpleRequestBus::Events::GetLeaderboardForUserCharacters)
				->Event("GrantCharacterToUser", &PlayFabClient_ClientSimpleRequestBus::Events::GrantCharacterToUser)
				->Event("UpdateCharacterStatistics", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateCharacterStatistics)
				->Event("GetCharacterData", &PlayFabClient_ClientSimpleRequestBus::Events::GetCharacterData)
				->Event("GetCharacterReadOnlyData", &PlayFabClient_ClientSimpleRequestBus::Events::GetCharacterReadOnlyData)
				->Event("UpdateCharacterData", &PlayFabClient_ClientSimpleRequestBus::Events::UpdateCharacterData)
				->Event("AcceptTrade", &PlayFabClient_ClientSimpleRequestBus::Events::AcceptTrade)
				->Event("CancelTrade", &PlayFabClient_ClientSimpleRequestBus::Events::CancelTrade)
				->Event("GetPlayerTrades", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerTrades)
				->Event("GetTradeStatus", &PlayFabClient_ClientSimpleRequestBus::Events::GetTradeStatus)
				->Event("OpenTrade", &PlayFabClient_ClientSimpleRequestBus::Events::OpenTrade)
				->Event("AttributeInstall", &PlayFabClient_ClientSimpleRequestBus::Events::AttributeInstall)
				->Event("GetPlayerSegments", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerSegments)
				->Event("GetPlayerTags", &PlayFabClient_ClientSimpleRequestBus::Events::GetPlayerTags)
				->Event("AndroidDevicePushNotificationRegistration", &PlayFabClient_ClientSimpleRequestBus::Events::AndroidDevicePushNotificationRegistration)
				->Event("RegisterForIOSPushNotification", &PlayFabClient_ClientSimpleRequestBus::Events::RegisterForIOSPushNotification)
				->Event("RestoreIOSPurchases", &PlayFabClient_ClientSimpleRequestBus::Events::RestoreIOSPurchases)
				->Event("ValidateAmazonIAPReceipt", &PlayFabClient_ClientSimpleRequestBus::Events::ValidateAmazonIAPReceipt)
				->Event("ValidateGooglePlayPurchase", &PlayFabClient_ClientSimpleRequestBus::Events::ValidateGooglePlayPurchase)
				->Event("ValidateIOSReceipt", &PlayFabClient_ClientSimpleRequestBus::Events::ValidateIOSReceipt)
				->Event("ValidateWindowsStoreReceipt", &PlayFabClient_ClientSimpleRequestBus::Events::ValidateWindowsStoreReceipt);

			// Reflect the ADDRESSED notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabClient_ClientNotificationBus>("PlayFabClientNotificationBus")
				->Handler<PlayFabClient_ClientBehaviorBusHandler>();

			// Reflect the GLOBAL notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabClient_ClientGlobalNotificationBus>("PlayFabClientGlobalNotificationBus")
				->Handler<PlayFabClient_ClientGlobalBehaviorBusHandler>();                
