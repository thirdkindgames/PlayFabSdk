...
namespace PlayFabServerSdk
{
    ...
    class PlayFabServer_AdminNotifications
    ...
    using PlayFabServer_AdminNotificationBus = AZ::EBus<PlayFabServer_AdminNotifications>;

    // Global notification bus - use this bus when you want to listen for all responses to a particular type of request. 
    class PlayFabServer_AdminGlobalNotifications
        : public AZ::EBusTraits
    {
    ...
    using PlayFabServer_AdminGlobalNotificationBus = AZ::EBus<PlayFabServer_AdminGlobalNotifications>;
