...
#include "StdAfx.h"
#include "PlayFabServer_MatchmakerBehaviorContext.h"
#include <AzCore/RTTI/ReflectContext.h>
#include <AzCore/RTTI/BehaviorContext.h>

#include "PlayFabServerSdk/PlayFabServer_MatchmakerNotificationBus.h"
...
namespace PlayFabServerSdk
{
    ...
    template<typename T>
    class PlayFabServer_MatchmakerBehaviorBusBaseHandler : 
    ...
    protected:
        ...
        // Constructor
        PlayFabServer_MatchmakerBehaviorBusBaseHandler()
        {
	...
	class PlayFabServer_MatchmakerBehaviorBusHandler : 
		public PlayFabServer_MatchmakerNotificationBus::Handler, 
		public PlayFabServer_MatchmakerBehaviorBusBaseHandler<PlayFabServer_MatchmakerBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabServer_MatchmakerBehaviorBusHandler,"{96a8f3e4-5088-5aad-b289-c082733221f1}",AZ::BehaviorEBusHandler)
	...
	class PlayFabServer_MatchmakerGlobalBehaviorBusHandler : 
		public PlayFabServer_MatchmakerGlobalNotificationBus::Handler, 
		public PlayFabServer_MatchmakerBehaviorBusBaseHandler<PlayFabServer_MatchmakerGlobalBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabServer_MatchmakerGlobalBehaviorBusHandler,"{5cd1b821-9573-5b62-9c63-2eb008979756}",AZ::BehaviorEBusHandler)
    ...
    //-----------------------------------------------------------------------------------------------------
	void PlayFabServer_MatchmakerBehaviorContext::Reflect(AZ::ReflectContext* context)
	{
		AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context);
		if (behaviorContext)
		{
			// Reflect the request bus
			behaviorContext->EBus<PlayFabServer_MatchmakerSimpleRequestBus>("PlayFabMatchmakerRequestBus")
				->Event("AuthUser", &PlayFabServer_MatchmakerSimpleRequestBus::Events::AuthUser)
				->Event("PlayerJoined", &PlayFabServer_MatchmakerSimpleRequestBus::Events::PlayerJoined)
				->Event("PlayerLeft", &PlayFabServer_MatchmakerSimpleRequestBus::Events::PlayerLeft)
				->Event("StartGame", &PlayFabServer_MatchmakerSimpleRequestBus::Events::StartGame)
				->Event("UserInfo", &PlayFabServer_MatchmakerSimpleRequestBus::Events::UserInfo);

			// Reflect the ADDRESSED notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabServer_MatchmakerNotificationBus>("PlayFabMatchmakerNotificationBus")
				->Handler<PlayFabServer_MatchmakerBehaviorBusHandler>();

			// Reflect the GLOBAL notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabServer_MatchmakerGlobalNotificationBus>("PlayFabMatchmakerGlobalNotificationBus")
				->Handler<PlayFabServer_MatchmakerGlobalBehaviorBusHandler>();                
