...
namespace PlayFabComboSdk
{
    ...
    protected:
        ...
        void GetAllActionGroups(ProcessApiCallback<AdminModels::GetAllActionGroupsResult> callback = nullptr, ErrorCallback errorCallback = nullptr, void* customData = nullptr) override;
