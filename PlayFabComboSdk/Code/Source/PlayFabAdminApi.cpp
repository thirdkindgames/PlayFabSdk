...
#include "PlayFabComboSdk/PlayFabCombo_AdminNotificationBus.h" // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS: dbowen (2017/08/11)
...
{
    EBUS_EVENT_ID(request.mRequestId,PlayFabCombo_AdminNotificationBus, OnError, error);     
    EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnError, error, request.mRequestId);
}
// THIRD_KIND_END
...
void PlayFabAdminApi::OnCreatePlayerSharedSecretResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnCreatePlayerSharedSecret, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnCreatePlayerSharedSecret, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeletePlayerSharedSecretResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeletePlayerSharedSecret, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeletePlayerSharedSecret, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayerSharedSecretsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayerSharedSecrets, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayerSharedSecrets, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPolicyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPolicy, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPolicy, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetPlayerSecretResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetPlayerSecret, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetPlayerSecret, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdatePlayerSharedSecretResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdatePlayerSharedSecret, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdatePlayerSharedSecret, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdatePolicyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdatePolicy, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdatePolicy, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnBanUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnBanUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnBanUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeletePlayerResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeletePlayer, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeletePlayer, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserAccountInfoResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserAccountInfo, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserAccountInfo, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnResetUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnResetUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnResetUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRevokeAllBansForUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRevokeAllBansForUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRevokeAllBansForUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRevokeBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRevokeBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRevokeBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSendAccountRecoveryEmailResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSendAccountRecoveryEmail, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSendAccountRecoveryEmail, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserTitleDisplayNameResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserTitleDisplayName, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserTitleDisplayName, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnCreatePlayerStatisticDefinitionResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnCreatePlayerStatisticDefinition, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnCreatePlayerStatisticDefinition, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeleteUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeleteUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeleteUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetDataReportResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetDataReport, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetDataReport, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayerStatisticDefinitionsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayerStatisticDefinitions, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayerStatisticDefinitions, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayerStatisticVersionsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayerStatisticVersions, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayerStatisticVersions, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserPublisherInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserPublisherInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserPublisherInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserPublisherReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserPublisherReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserPublisherReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnIncrementPlayerStatisticVersionResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnIncrementPlayerStatisticVersion, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnIncrementPlayerStatisticVersion, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRefundPurchaseResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRefundPurchase, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRefundPurchase, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnResetUserStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnResetUserStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnResetUserStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnResolvePurchaseDisputeResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnResolvePurchaseDispute, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnResolvePurchaseDispute, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdatePlayerStatisticDefinitionResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdatePlayerStatisticDefinition, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdatePlayerStatisticDefinition, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserPublisherInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserPublisherInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserPublisherInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserPublisherReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserPublisherReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserPublisherReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateUserReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateUserReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateUserReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAddNewsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAddNews, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAddNews, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAddVirtualCurrencyTypesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAddVirtualCurrencyTypes, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAddVirtualCurrencyTypes, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeleteStoreResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeleteStore, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeleteStore, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetCatalogItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetCatalogItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetCatalogItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetRandomResultTablesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetRandomResultTables, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetRandomResultTables, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetStoreItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetStoreItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetStoreItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetTitleDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetTitleData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetTitleData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetTitleInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetTitleInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetTitleInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnListVirtualCurrencyTypesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnListVirtualCurrencyTypes, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnListVirtualCurrencyTypes, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRemoveVirtualCurrencyTypesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRemoveVirtualCurrencyTypes, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRemoveVirtualCurrencyTypes, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetCatalogItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetCatalogItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetCatalogItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetStoreItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetStoreItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetStoreItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetTitleDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetTitleData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetTitleData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetTitleInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetTitleInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetTitleInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetupPushNotificationResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetupPushNotification, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetupPushNotification, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateCatalogItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateCatalogItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateCatalogItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateRandomResultTablesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateRandomResultTables, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateRandomResultTables, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateStoreItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateStoreItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateStoreItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAddUserVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAddUserVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAddUserVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetUserInventoryResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetUserInventory, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetUserInventory, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGrantItemsToUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGrantItemsToUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGrantItemsToUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRevokeInventoryItemResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRevokeInventoryItem, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRevokeInventoryItem, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSubtractUserVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSubtractUserVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSubtractUserVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetMatchmakerGameInfoResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetMatchmakerGameInfo, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetMatchmakerGameInfo, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetMatchmakerGameModesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetMatchmakerGameModes, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetMatchmakerGameModes, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnModifyMatchmakerGameModesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnModifyMatchmakerGameModes, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnModifyMatchmakerGameModes, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAddServerBuildResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAddServerBuild, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAddServerBuild, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetServerBuildInfoResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetServerBuildInfo, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetServerBuildInfo, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetServerBuildUploadUrlResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetServerBuildUploadUrl, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetServerBuildUploadUrl, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnListServerBuildsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnListServerBuilds, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnListServerBuilds, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnModifyServerBuildResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnModifyServerBuild, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnModifyServerBuild, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRemoveServerBuildResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRemoveServerBuild, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRemoveServerBuild, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetCloudScriptRevisionResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetCloudScriptRevision, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetCloudScriptRevision, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetCloudScriptVersionsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetCloudScriptVersions, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetCloudScriptVersions, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnSetPublishedRevisionResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnSetPublishedRevision, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnSetPublishedRevision, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateCloudScriptResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateCloudScript, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateCloudScript, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeleteContentResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeleteContent, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeleteContent, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetContentListResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetContentList, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetContentList, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetContentUploadUrlResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetContentUploadUrl, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetContentUploadUrl, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnResetCharacterStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnResetCharacterStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnResetCharacterStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAddPlayerTagResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAddPlayerTag, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAddPlayerTag, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetAllActionGroupsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetAllActionGroups, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetAllActionGroups, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetAllSegmentsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetAllSegments, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetAllSegments, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayerSegmentsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayerSegments, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayerSegments, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayersInSegmentResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayersInSegment, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayersInSegment, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetPlayerTagsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetPlayerTags, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetPlayerTags, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRemovePlayerTagResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRemovePlayerTag, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRemovePlayerTag, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnAbortTaskInstanceResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnAbortTaskInstance, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnAbortTaskInstance, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnCreateActionsOnPlayersInSegmentTaskResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnCreateActionsOnPlayersInSegmentTask, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnCreateActionsOnPlayersInSegmentTask, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnCreateCloudScriptTaskResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnCreateCloudScriptTask, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnCreateCloudScriptTask, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnDeleteTaskResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnDeleteTask, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnDeleteTask, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetActionsOnPlayersInSegmentTaskInstanceResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetActionsOnPlayersInSegmentTaskInstance, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetActionsOnPlayersInSegmentTaskInstance, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetCloudScriptTaskInstanceResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetCloudScriptTaskInstance, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetCloudScriptTaskInstance, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetTaskInstancesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetTaskInstances, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetTaskInstances, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnGetTasksResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnGetTasks, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnGetTasks, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnRunTaskResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnRunTask, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnRunTask, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabAdminApi::OnUpdateTaskResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_AdminNotificationBus, OnUpdateTask, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_AdminGlobalNotificationBus, OnUpdateTask, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
