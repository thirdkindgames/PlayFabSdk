...
#include "PlayFabComboSdk/PlayFabCombo_ServerNotificationBus.h" // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS: dbowen (2017/08/11)
...
{
    EBUS_EVENT_ID(request.mRequestId,PlayFabCombo_ServerNotificationBus, OnError, error);     
    EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnError, error, request.mRequestId);
}
// THIRD_KIND_END
...
void PlayFabServerApi::OnAuthenticateSessionTicketResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAuthenticateSessionTicket, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAuthenticateSessionTicket, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetPlayerSecretResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetPlayerSecret, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetPlayerSecret, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnBanUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnBanUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnBanUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerProfileResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerProfile, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerProfile, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayFabIDsFromFacebookIDsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayFabIDsFromFacebookIDs, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayFabIDsFromFacebookIDs, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayFabIDsFromSteamIDsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayFabIDsFromSteamIDs, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayFabIDsFromSteamIDs, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserAccountInfoResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserAccountInfo, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserAccountInfo, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRevokeAllBansForUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRevokeAllBansForUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRevokeAllBansForUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRevokeBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRevokeBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRevokeBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSendPushNotificationResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSendPushNotification, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSendPushNotification, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateAvatarUrlResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateAvatarUrl, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateAvatarUrl, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateBansResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateBans, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateBans, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnDeleteUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnDeleteUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnDeleteUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetFriendLeaderboardResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetFriendLeaderboard, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetFriendLeaderboard, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetLeaderboardResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetLeaderboard, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetLeaderboard, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetLeaderboardAroundUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetLeaderboardAroundUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetLeaderboardAroundUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerCombinedInfoResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerCombinedInfo, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerCombinedInfo, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerStatisticVersionsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerStatisticVersions, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerStatisticVersions, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserPublisherInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserPublisherInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserPublisherInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserPublisherReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserPublisherReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserPublisherReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdatePlayerStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdatePlayerStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdatePlayerStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserPublisherInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserPublisherInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserPublisherInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserPublisherReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserPublisherReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserPublisherReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCatalogItemsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCatalogItems, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCatalogItems, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetTimeResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetTime, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetTime, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetTitleDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetTitleData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetTitleData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetTitleInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetTitleInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetTitleInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetTitleNewsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetTitleNews, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetTitleNews, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetPublisherDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetPublisherData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetPublisherData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetTitleDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetTitleData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetTitleData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetTitleInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetTitleInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetTitleInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAddCharacterVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAddCharacterVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAddCharacterVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAddUserVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAddUserVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAddUserVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnConsumeItemResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnConsumeItem, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnConsumeItem, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnEvaluateRandomResultTableResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnEvaluateRandomResultTable, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnEvaluateRandomResultTable, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterInventoryResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterInventory, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterInventory, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetRandomResultTablesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetRandomResultTables, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetRandomResultTables, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetUserInventoryResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetUserInventory, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetUserInventory, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGrantItemsToCharacterResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGrantItemsToCharacter, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGrantItemsToCharacter, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGrantItemsToUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGrantItemsToUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGrantItemsToUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGrantItemsToUsersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGrantItemsToUsers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGrantItemsToUsers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnModifyItemUsesResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnModifyItemUses, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnModifyItemUses, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnMoveItemToCharacterFromCharacterResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnMoveItemToCharacterFromCharacter, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnMoveItemToCharacterFromCharacter, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnMoveItemToCharacterFromUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnMoveItemToCharacterFromUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnMoveItemToCharacterFromUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnMoveItemToUserFromCharacterResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnMoveItemToUserFromCharacter, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnMoveItemToUserFromCharacter, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRedeemCouponResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRedeemCoupon, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRedeemCoupon, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnReportPlayerResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnReportPlayer, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnReportPlayer, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRevokeInventoryItemResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRevokeInventoryItem, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRevokeInventoryItem, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSubtractCharacterVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSubtractCharacterVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSubtractCharacterVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSubtractUserVirtualCurrencyResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSubtractUserVirtualCurrency, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSubtractUserVirtualCurrency, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUnlockContainerInstanceResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUnlockContainerInstance, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUnlockContainerInstance, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUnlockContainerItemResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUnlockContainerItem, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUnlockContainerItem, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateUserInventoryItemCustomDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateUserInventoryItemCustomData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateUserInventoryItemCustomData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAddFriendResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAddFriend, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAddFriend, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetFriendsListResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetFriendsList, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetFriendsList, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRemoveFriendResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRemoveFriend, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRemoveFriend, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetFriendTagsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetFriendTags, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetFriendTags, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnDeregisterGameResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnDeregisterGame, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnDeregisterGame, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnNotifyMatchmakerPlayerLeftResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnNotifyMatchmakerPlayerLeft, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnNotifyMatchmakerPlayerLeft, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRedeemMatchmakerTicketResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRedeemMatchmakerTicket, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRedeemMatchmakerTicket, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRefreshGameServerInstanceHeartbeatResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRefreshGameServerInstanceHeartbeat, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRefreshGameServerInstanceHeartbeat, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRegisterGameResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRegisterGame, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRegisterGame, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetGameServerInstanceDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetGameServerInstanceData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetGameServerInstanceData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetGameServerInstanceStateResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetGameServerInstanceState, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetGameServerInstanceState, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnSetGameServerInstanceTagsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnSetGameServerInstanceTags, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnSetGameServerInstanceTags, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnWriteCharacterEventResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnWriteCharacterEvent, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnWriteCharacterEvent, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnWritePlayerEventResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnWritePlayerEvent, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnWritePlayerEvent, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnWriteTitleEventResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnWriteTitleEvent, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnWriteTitleEvent, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAddSharedGroupMembersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAddSharedGroupMembers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAddSharedGroupMembers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnCreateSharedGroupResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnCreateSharedGroup, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnCreateSharedGroup, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnDeleteSharedGroupResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnDeleteSharedGroup, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnDeleteSharedGroup, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetSharedGroupDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetSharedGroupData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetSharedGroupData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRemoveSharedGroupMembersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRemoveSharedGroupMembers, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRemoveSharedGroupMembers, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateSharedGroupDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateSharedGroupData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateSharedGroupData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnExecuteCloudScriptResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnExecuteCloudScript, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnExecuteCloudScript, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetContentDownloadUrlResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetContentDownloadUrl, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetContentDownloadUrl, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnDeleteCharacterFromUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnDeleteCharacterFromUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnDeleteCharacterFromUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetAllUsersCharactersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetAllUsersCharacters, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetAllUsersCharacters, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterLeaderboardResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterLeaderboard, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterLeaderboard, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetLeaderboardAroundCharacterResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetLeaderboardAroundCharacter, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetLeaderboardAroundCharacter, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetLeaderboardForUserCharactersResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetLeaderboardForUserCharacters, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetLeaderboardForUserCharacters, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGrantCharacterToUserResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGrantCharacterToUser, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGrantCharacterToUser, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateCharacterStatisticsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateCharacterStatistics, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateCharacterStatistics, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetCharacterReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetCharacterReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetCharacterReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateCharacterDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateCharacterData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateCharacterData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateCharacterInternalDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateCharacterInternalData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateCharacterInternalData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnUpdateCharacterReadOnlyDataResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnUpdateCharacterReadOnlyData, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnUpdateCharacterReadOnlyData, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAddPlayerTagResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAddPlayerTag, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAddPlayerTag, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetAllActionGroupsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetAllActionGroups, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetAllActionGroups, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetAllSegmentsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetAllSegments, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetAllSegments, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerSegmentsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerSegments, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerSegments, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayersInSegmentResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayersInSegment, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayersInSegment, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnGetPlayerTagsResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnGetPlayerTags, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnGetPlayerTags, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnRemovePlayerTagResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnRemovePlayerTag, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnRemovePlayerTag, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
...
void PlayFabServerApi::OnAwardSteamAchievementResult(PlayFabRequest* request)
{
    if (PlayFabBaseModel::DecodeRequest(request))
    {
		...
		EBUS_EVENT_ID(request->mRequestId,PlayFabCombo_ServerNotificationBus, OnAwardSteamAchievement, *outResult); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
        EBUS_EVENT(PlayFabCombo_ServerGlobalNotificationBus, OnAwardSteamAchievement, *outResult, request->mRequestId); // #THIRD_KIND_PLAYFAB_NOTIFICATION_BUS_: dbowen (2017/08/11)
