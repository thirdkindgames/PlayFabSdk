...
namespace PlayFabComboSdk
{
    ...
    class PlayFabCombo_ServerSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabCombo_ServerSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE5}", CryHooksModule);

        PlayFabCombo_ServerSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabComboSdk_abf1282cbb534d908e39e0684e34cb20, PlayFabComboSdk::PlayFabCombo_ServerSdkModule)
