...
namespace PlayFabComboSdk
{
    ...
    class PlayFabCombo_AdminSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabCombo_AdminSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE6}", CryHooksModule);

        PlayFabCombo_AdminSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabComboSdk_abf1282cbb534d908e39e0684e34cb20, PlayFabComboSdk::PlayFabCombo_AdminSdkModule)
