...
#include "StdAfx.h"
#include "PlayFabCombo_AdminBehaviorContext.h"
#include <AzCore/RTTI/ReflectContext.h>
#include <AzCore/RTTI/BehaviorContext.h>

#include "PlayFabComboSdk/PlayFabCombo_AdminNotificationBus.h"
...
namespace PlayFabComboSdk
{
    ...
    template<typename T>
    class PlayFabCombo_AdminBehaviorBusBaseHandler : 
    ...
    protected:
        ...
        // Constructor
        PlayFabCombo_AdminBehaviorBusBaseHandler()
        {
	...
	class PlayFabCombo_AdminBehaviorBusHandler : 
		public PlayFabCombo_AdminNotificationBus::Handler, 
		public PlayFabCombo_AdminBehaviorBusBaseHandler<PlayFabCombo_AdminBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabCombo_AdminBehaviorBusHandler,"{2ed69a75-33ce-52d4-b669-0627ba0f8551}",AZ::BehaviorEBusHandler)
	...
	class PlayFabCombo_AdminGlobalBehaviorBusHandler : 
		public PlayFabCombo_AdminGlobalNotificationBus::Handler, 
		public PlayFabCombo_AdminBehaviorBusBaseHandler<PlayFabCombo_AdminGlobalBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabCombo_AdminGlobalBehaviorBusHandler,"{1c259055-ac15-58f5-9eda-afcad38e4b3a}",AZ::BehaviorEBusHandler)
    ...
    //-----------------------------------------------------------------------------------------------------
	void PlayFabCombo_AdminBehaviorContext::Reflect(AZ::ReflectContext* context)
	{
		AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context);
		if (behaviorContext)
		{
			// Reflect the request bus
			behaviorContext->EBus<PlayFabCombo_AdminSimpleRequestBus>("PlayFabAdminRequestBus")
				->Event("CreatePlayerSharedSecret", &PlayFabCombo_AdminSimpleRequestBus::Events::CreatePlayerSharedSecret)
				->Event("DeletePlayerSharedSecret", &PlayFabCombo_AdminSimpleRequestBus::Events::DeletePlayerSharedSecret)
				->Event("GetPlayerSharedSecrets", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayerSharedSecrets)
				->Event("GetPolicy", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPolicy)
				->Event("SetPlayerSecret", &PlayFabCombo_AdminSimpleRequestBus::Events::SetPlayerSecret)
				->Event("UpdatePlayerSharedSecret", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdatePlayerSharedSecret)
				->Event("UpdatePolicy", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdatePolicy)
				->Event("BanUsers", &PlayFabCombo_AdminSimpleRequestBus::Events::BanUsers)
				->Event("DeletePlayer", &PlayFabCombo_AdminSimpleRequestBus::Events::DeletePlayer)
				->Event("GetUserAccountInfo", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserAccountInfo)
				->Event("GetUserBans", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserBans)
				->Event("ResetUsers", &PlayFabCombo_AdminSimpleRequestBus::Events::ResetUsers)
				->Event("RevokeAllBansForUser", &PlayFabCombo_AdminSimpleRequestBus::Events::RevokeAllBansForUser)
				->Event("RevokeBans", &PlayFabCombo_AdminSimpleRequestBus::Events::RevokeBans)
				->Event("SendAccountRecoveryEmail", &PlayFabCombo_AdminSimpleRequestBus::Events::SendAccountRecoveryEmail)
				->Event("UpdateBans", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateBans)
				->Event("UpdateUserTitleDisplayName", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserTitleDisplayName)
				->Event("CreatePlayerStatisticDefinition", &PlayFabCombo_AdminSimpleRequestBus::Events::CreatePlayerStatisticDefinition)
				->Event("DeleteUsers", &PlayFabCombo_AdminSimpleRequestBus::Events::DeleteUsers)
				->Event("GetDataReport", &PlayFabCombo_AdminSimpleRequestBus::Events::GetDataReport)
				->Event("GetPlayerStatisticDefinitions", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayerStatisticDefinitions)
				->Event("GetPlayerStatisticVersions", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayerStatisticVersions)
				->Event("GetUserData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserData)
				->Event("GetUserInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserInternalData)
				->Event("GetUserPublisherData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserPublisherData)
				->Event("GetUserPublisherInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserPublisherInternalData)
				->Event("GetUserPublisherReadOnlyData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserPublisherReadOnlyData)
				->Event("GetUserReadOnlyData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserReadOnlyData)
				->Event("IncrementPlayerStatisticVersion", &PlayFabCombo_AdminSimpleRequestBus::Events::IncrementPlayerStatisticVersion)
				->Event("RefundPurchase", &PlayFabCombo_AdminSimpleRequestBus::Events::RefundPurchase)
				->Event("ResetUserStatistics", &PlayFabCombo_AdminSimpleRequestBus::Events::ResetUserStatistics)
				->Event("ResolvePurchaseDispute", &PlayFabCombo_AdminSimpleRequestBus::Events::ResolvePurchaseDispute)
				->Event("UpdatePlayerStatisticDefinition", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdatePlayerStatisticDefinition)
				->Event("UpdateUserData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserData)
				->Event("UpdateUserInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserInternalData)
				->Event("UpdateUserPublisherData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserPublisherData)
				->Event("UpdateUserPublisherInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserPublisherInternalData)
				->Event("UpdateUserPublisherReadOnlyData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserPublisherReadOnlyData)
				->Event("UpdateUserReadOnlyData", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateUserReadOnlyData)
				->Event("AddNews", &PlayFabCombo_AdminSimpleRequestBus::Events::AddNews)
				->Event("AddVirtualCurrencyTypes", &PlayFabCombo_AdminSimpleRequestBus::Events::AddVirtualCurrencyTypes)
				->Event("DeleteStore", &PlayFabCombo_AdminSimpleRequestBus::Events::DeleteStore)
				->Event("GetCatalogItems", &PlayFabCombo_AdminSimpleRequestBus::Events::GetCatalogItems)
				->Event("GetPublisherData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPublisherData)
				->Event("GetRandomResultTables", &PlayFabCombo_AdminSimpleRequestBus::Events::GetRandomResultTables)
				->Event("GetStoreItems", &PlayFabCombo_AdminSimpleRequestBus::Events::GetStoreItems)
				->Event("GetTitleData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetTitleData)
				->Event("GetTitleInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::GetTitleInternalData)
				->Event("ListVirtualCurrencyTypes", &PlayFabCombo_AdminSimpleRequestBus::Events::ListVirtualCurrencyTypes)
				->Event("RemoveVirtualCurrencyTypes", &PlayFabCombo_AdminSimpleRequestBus::Events::RemoveVirtualCurrencyTypes)
				->Event("SetCatalogItems", &PlayFabCombo_AdminSimpleRequestBus::Events::SetCatalogItems)
				->Event("SetStoreItems", &PlayFabCombo_AdminSimpleRequestBus::Events::SetStoreItems)
				->Event("SetTitleData", &PlayFabCombo_AdminSimpleRequestBus::Events::SetTitleData)
				->Event("SetTitleInternalData", &PlayFabCombo_AdminSimpleRequestBus::Events::SetTitleInternalData)
				->Event("SetupPushNotification", &PlayFabCombo_AdminSimpleRequestBus::Events::SetupPushNotification)
				->Event("UpdateCatalogItems", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateCatalogItems)
				->Event("UpdateRandomResultTables", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateRandomResultTables)
				->Event("UpdateStoreItems", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateStoreItems)
				->Event("AddUserVirtualCurrency", &PlayFabCombo_AdminSimpleRequestBus::Events::AddUserVirtualCurrency)
				->Event("GetUserInventory", &PlayFabCombo_AdminSimpleRequestBus::Events::GetUserInventory)
				->Event("GrantItemsToUsers", &PlayFabCombo_AdminSimpleRequestBus::Events::GrantItemsToUsers)
				->Event("RevokeInventoryItem", &PlayFabCombo_AdminSimpleRequestBus::Events::RevokeInventoryItem)
				->Event("SubtractUserVirtualCurrency", &PlayFabCombo_AdminSimpleRequestBus::Events::SubtractUserVirtualCurrency)
				->Event("GetMatchmakerGameInfo", &PlayFabCombo_AdminSimpleRequestBus::Events::GetMatchmakerGameInfo)
				->Event("GetMatchmakerGameModes", &PlayFabCombo_AdminSimpleRequestBus::Events::GetMatchmakerGameModes)
				->Event("ModifyMatchmakerGameModes", &PlayFabCombo_AdminSimpleRequestBus::Events::ModifyMatchmakerGameModes)
				->Event("AddServerBuild", &PlayFabCombo_AdminSimpleRequestBus::Events::AddServerBuild)
				->Event("GetServerBuildInfo", &PlayFabCombo_AdminSimpleRequestBus::Events::GetServerBuildInfo)
				->Event("GetServerBuildUploadUrl", &PlayFabCombo_AdminSimpleRequestBus::Events::GetServerBuildUploadUrl)
				->Event("ListServerBuilds", &PlayFabCombo_AdminSimpleRequestBus::Events::ListServerBuilds)
				->Event("ModifyServerBuild", &PlayFabCombo_AdminSimpleRequestBus::Events::ModifyServerBuild)
				->Event("RemoveServerBuild", &PlayFabCombo_AdminSimpleRequestBus::Events::RemoveServerBuild)
				->Event("SetPublisherData", &PlayFabCombo_AdminSimpleRequestBus::Events::SetPublisherData)
				->Event("GetCloudScriptRevision", &PlayFabCombo_AdminSimpleRequestBus::Events::GetCloudScriptRevision)
				->Event("GetCloudScriptVersions", &PlayFabCombo_AdminSimpleRequestBus::Events::GetCloudScriptVersions)
				->Event("SetPublishedRevision", &PlayFabCombo_AdminSimpleRequestBus::Events::SetPublishedRevision)
				->Event("UpdateCloudScript", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateCloudScript)
				->Event("DeleteContent", &PlayFabCombo_AdminSimpleRequestBus::Events::DeleteContent)
				->Event("GetContentList", &PlayFabCombo_AdminSimpleRequestBus::Events::GetContentList)
				->Event("GetContentUploadUrl", &PlayFabCombo_AdminSimpleRequestBus::Events::GetContentUploadUrl)
				->Event("ResetCharacterStatistics", &PlayFabCombo_AdminSimpleRequestBus::Events::ResetCharacterStatistics)
				->Event("AddPlayerTag", &PlayFabCombo_AdminSimpleRequestBus::Events::AddPlayerTag)
				->Event("GetAllActionGroups", &PlayFabCombo_AdminSimpleRequestBus::Events::GetAllActionGroups)
				->Event("GetAllSegments", &PlayFabCombo_AdminSimpleRequestBus::Events::GetAllSegments)
				->Event("GetPlayerSegments", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayerSegments)
				->Event("GetPlayersInSegment", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayersInSegment)
				->Event("GetPlayerTags", &PlayFabCombo_AdminSimpleRequestBus::Events::GetPlayerTags)
				->Event("RemovePlayerTag", &PlayFabCombo_AdminSimpleRequestBus::Events::RemovePlayerTag)
				->Event("AbortTaskInstance", &PlayFabCombo_AdminSimpleRequestBus::Events::AbortTaskInstance)
				->Event("CreateActionsOnPlayersInSegmentTask", &PlayFabCombo_AdminSimpleRequestBus::Events::CreateActionsOnPlayersInSegmentTask)
				->Event("CreateCloudScriptTask", &PlayFabCombo_AdminSimpleRequestBus::Events::CreateCloudScriptTask)
				->Event("DeleteTask", &PlayFabCombo_AdminSimpleRequestBus::Events::DeleteTask)
				->Event("GetActionsOnPlayersInSegmentTaskInstance", &PlayFabCombo_AdminSimpleRequestBus::Events::GetActionsOnPlayersInSegmentTaskInstance)
				->Event("GetCloudScriptTaskInstance", &PlayFabCombo_AdminSimpleRequestBus::Events::GetCloudScriptTaskInstance)
				->Event("GetTaskInstances", &PlayFabCombo_AdminSimpleRequestBus::Events::GetTaskInstances)
				->Event("GetTasks", &PlayFabCombo_AdminSimpleRequestBus::Events::GetTasks)
				->Event("RunTask", &PlayFabCombo_AdminSimpleRequestBus::Events::RunTask)
				->Event("UpdateTask", &PlayFabCombo_AdminSimpleRequestBus::Events::UpdateTask);

			// Reflect the ADDRESSED notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabCombo_AdminNotificationBus>("PlayFabAdminNotificationBus")
				->Handler<PlayFabCombo_AdminBehaviorBusHandler>();

			// Reflect the GLOBAL notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabCombo_AdminGlobalNotificationBus>("PlayFabAdminGlobalNotificationBus")
				->Handler<PlayFabCombo_AdminGlobalBehaviorBusHandler>();                
