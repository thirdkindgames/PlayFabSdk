...
namespace PlayFabComboSdk
{
    ...
    class PlayFabCombo_ClientSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabCombo_ClientSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE4}", CryHooksModule);

        PlayFabCombo_ClientSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabComboSdk_abf1282cbb534d908e39e0684e34cb20, PlayFabComboSdk::PlayFabCombo_ClientSdkModule)
