...
#include "StdAfx.h"
#include "PlayFabCombo_ServerBehaviorContext.h"
#include <AzCore/RTTI/ReflectContext.h>
#include <AzCore/RTTI/BehaviorContext.h>

#include "PlayFabComboSdk/PlayFabCombo_ServerNotificationBus.h"
...
namespace PlayFabComboSdk
{
    ...
    template<typename T>
    class PlayFabCombo_ServerBehaviorBusBaseHandler : 
    ...
    protected:
        ...
        // Constructor
        PlayFabCombo_ServerBehaviorBusBaseHandler()
        {
	...
	class PlayFabCombo_ServerBehaviorBusHandler : 
		public PlayFabCombo_ServerNotificationBus::Handler, 
		public PlayFabCombo_ServerBehaviorBusBaseHandler<PlayFabCombo_ServerBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabCombo_ServerBehaviorBusHandler,"{e830f5b5-e939-580f-8571-184d30b21963}",AZ::BehaviorEBusHandler)
	...
	class PlayFabCombo_ServerGlobalBehaviorBusHandler : 
		public PlayFabCombo_ServerGlobalNotificationBus::Handler, 
		public PlayFabCombo_ServerBehaviorBusBaseHandler<PlayFabCombo_ServerGlobalBehaviorBusHandler>
	{
   
	public:
        
		AZ_RTTI(PlayFabCombo_ServerGlobalBehaviorBusHandler,"{6723acff-55c2-559d-bb06-66b99ff00a06}",AZ::BehaviorEBusHandler)
    ...
    //-----------------------------------------------------------------------------------------------------
	void PlayFabCombo_ServerBehaviorContext::Reflect(AZ::ReflectContext* context)
	{
		AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context);
		if (behaviorContext)
		{
			// Reflect the request bus
			behaviorContext->EBus<PlayFabCombo_ServerSimpleRequestBus>("PlayFabServerRequestBus")
				->Event("AuthenticateSessionTicket", &PlayFabCombo_ServerSimpleRequestBus::Events::AuthenticateSessionTicket)
				->Event("SetPlayerSecret", &PlayFabCombo_ServerSimpleRequestBus::Events::SetPlayerSecret)
				->Event("BanUsers", &PlayFabCombo_ServerSimpleRequestBus::Events::BanUsers)
				->Event("GetPlayerProfile", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerProfile)
				->Event("GetPlayFabIDsFromFacebookIDs", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayFabIDsFromFacebookIDs)
				->Event("GetPlayFabIDsFromSteamIDs", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayFabIDsFromSteamIDs)
				->Event("GetUserAccountInfo", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserAccountInfo)
				->Event("GetUserBans", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserBans)
				->Event("RevokeAllBansForUser", &PlayFabCombo_ServerSimpleRequestBus::Events::RevokeAllBansForUser)
				->Event("RevokeBans", &PlayFabCombo_ServerSimpleRequestBus::Events::RevokeBans)
				->Event("SendPushNotification", &PlayFabCombo_ServerSimpleRequestBus::Events::SendPushNotification)
				->Event("UpdateAvatarUrl", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateAvatarUrl)
				->Event("UpdateBans", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateBans)
				->Event("DeleteUsers", &PlayFabCombo_ServerSimpleRequestBus::Events::DeleteUsers)
				->Event("GetFriendLeaderboard", &PlayFabCombo_ServerSimpleRequestBus::Events::GetFriendLeaderboard)
				->Event("GetLeaderboard", &PlayFabCombo_ServerSimpleRequestBus::Events::GetLeaderboard)
				->Event("GetLeaderboardAroundUser", &PlayFabCombo_ServerSimpleRequestBus::Events::GetLeaderboardAroundUser)
				->Event("GetPlayerCombinedInfo", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerCombinedInfo)
				->Event("GetPlayerStatistics", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerStatistics)
				->Event("GetPlayerStatisticVersions", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerStatisticVersions)
				->Event("GetUserData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserData)
				->Event("GetUserInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserInternalData)
				->Event("GetUserPublisherData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserPublisherData)
				->Event("GetUserPublisherInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserPublisherInternalData)
				->Event("GetUserPublisherReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserPublisherReadOnlyData)
				->Event("GetUserReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserReadOnlyData)
				->Event("UpdatePlayerStatistics", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdatePlayerStatistics)
				->Event("UpdateUserData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserData)
				->Event("UpdateUserInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserInternalData)
				->Event("UpdateUserPublisherData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserPublisherData)
				->Event("UpdateUserPublisherInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserPublisherInternalData)
				->Event("UpdateUserPublisherReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserPublisherReadOnlyData)
				->Event("UpdateUserReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserReadOnlyData)
				->Event("GetCatalogItems", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCatalogItems)
				->Event("GetPublisherData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPublisherData)
				->Event("GetTime", &PlayFabCombo_ServerSimpleRequestBus::Events::GetTime)
				->Event("GetTitleData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetTitleData)
				->Event("GetTitleInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetTitleInternalData)
				->Event("GetTitleNews", &PlayFabCombo_ServerSimpleRequestBus::Events::GetTitleNews)
				->Event("SetPublisherData", &PlayFabCombo_ServerSimpleRequestBus::Events::SetPublisherData)
				->Event("SetTitleData", &PlayFabCombo_ServerSimpleRequestBus::Events::SetTitleData)
				->Event("SetTitleInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::SetTitleInternalData)
				->Event("AddCharacterVirtualCurrency", &PlayFabCombo_ServerSimpleRequestBus::Events::AddCharacterVirtualCurrency)
				->Event("AddUserVirtualCurrency", &PlayFabCombo_ServerSimpleRequestBus::Events::AddUserVirtualCurrency)
				->Event("ConsumeItem", &PlayFabCombo_ServerSimpleRequestBus::Events::ConsumeItem)
				->Event("EvaluateRandomResultTable", &PlayFabCombo_ServerSimpleRequestBus::Events::EvaluateRandomResultTable)
				->Event("GetCharacterInventory", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterInventory)
				->Event("GetRandomResultTables", &PlayFabCombo_ServerSimpleRequestBus::Events::GetRandomResultTables)
				->Event("GetUserInventory", &PlayFabCombo_ServerSimpleRequestBus::Events::GetUserInventory)
				->Event("GrantItemsToCharacter", &PlayFabCombo_ServerSimpleRequestBus::Events::GrantItemsToCharacter)
				->Event("GrantItemsToUser", &PlayFabCombo_ServerSimpleRequestBus::Events::GrantItemsToUser)
				->Event("GrantItemsToUsers", &PlayFabCombo_ServerSimpleRequestBus::Events::GrantItemsToUsers)
				->Event("ModifyItemUses", &PlayFabCombo_ServerSimpleRequestBus::Events::ModifyItemUses)
				->Event("MoveItemToCharacterFromCharacter", &PlayFabCombo_ServerSimpleRequestBus::Events::MoveItemToCharacterFromCharacter)
				->Event("MoveItemToCharacterFromUser", &PlayFabCombo_ServerSimpleRequestBus::Events::MoveItemToCharacterFromUser)
				->Event("MoveItemToUserFromCharacter", &PlayFabCombo_ServerSimpleRequestBus::Events::MoveItemToUserFromCharacter)
				->Event("RedeemCoupon", &PlayFabCombo_ServerSimpleRequestBus::Events::RedeemCoupon)
				->Event("ReportPlayer", &PlayFabCombo_ServerSimpleRequestBus::Events::ReportPlayer)
				->Event("RevokeInventoryItem", &PlayFabCombo_ServerSimpleRequestBus::Events::RevokeInventoryItem)
				->Event("SubtractCharacterVirtualCurrency", &PlayFabCombo_ServerSimpleRequestBus::Events::SubtractCharacterVirtualCurrency)
				->Event("SubtractUserVirtualCurrency", &PlayFabCombo_ServerSimpleRequestBus::Events::SubtractUserVirtualCurrency)
				->Event("UnlockContainerInstance", &PlayFabCombo_ServerSimpleRequestBus::Events::UnlockContainerInstance)
				->Event("UnlockContainerItem", &PlayFabCombo_ServerSimpleRequestBus::Events::UnlockContainerItem)
				->Event("UpdateUserInventoryItemCustomData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateUserInventoryItemCustomData)
				->Event("AddFriend", &PlayFabCombo_ServerSimpleRequestBus::Events::AddFriend)
				->Event("GetFriendsList", &PlayFabCombo_ServerSimpleRequestBus::Events::GetFriendsList)
				->Event("RemoveFriend", &PlayFabCombo_ServerSimpleRequestBus::Events::RemoveFriend)
				->Event("SetFriendTags", &PlayFabCombo_ServerSimpleRequestBus::Events::SetFriendTags)
				->Event("DeregisterGame", &PlayFabCombo_ServerSimpleRequestBus::Events::DeregisterGame)
				->Event("NotifyMatchmakerPlayerLeft", &PlayFabCombo_ServerSimpleRequestBus::Events::NotifyMatchmakerPlayerLeft)
				->Event("RedeemMatchmakerTicket", &PlayFabCombo_ServerSimpleRequestBus::Events::RedeemMatchmakerTicket)
				->Event("RefreshGameServerInstanceHeartbeat", &PlayFabCombo_ServerSimpleRequestBus::Events::RefreshGameServerInstanceHeartbeat)
				->Event("RegisterGame", &PlayFabCombo_ServerSimpleRequestBus::Events::RegisterGame)
				->Event("SetGameServerInstanceData", &PlayFabCombo_ServerSimpleRequestBus::Events::SetGameServerInstanceData)
				->Event("SetGameServerInstanceState", &PlayFabCombo_ServerSimpleRequestBus::Events::SetGameServerInstanceState)
				->Event("SetGameServerInstanceTags", &PlayFabCombo_ServerSimpleRequestBus::Events::SetGameServerInstanceTags)
				->Event("WriteCharacterEvent", &PlayFabCombo_ServerSimpleRequestBus::Events::WriteCharacterEvent)
				->Event("WritePlayerEvent", &PlayFabCombo_ServerSimpleRequestBus::Events::WritePlayerEvent)
				->Event("WriteTitleEvent", &PlayFabCombo_ServerSimpleRequestBus::Events::WriteTitleEvent)
				->Event("AddSharedGroupMembers", &PlayFabCombo_ServerSimpleRequestBus::Events::AddSharedGroupMembers)
				->Event("CreateSharedGroup", &PlayFabCombo_ServerSimpleRequestBus::Events::CreateSharedGroup)
				->Event("DeleteSharedGroup", &PlayFabCombo_ServerSimpleRequestBus::Events::DeleteSharedGroup)
				->Event("GetSharedGroupData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetSharedGroupData)
				->Event("RemoveSharedGroupMembers", &PlayFabCombo_ServerSimpleRequestBus::Events::RemoveSharedGroupMembers)
				->Event("UpdateSharedGroupData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateSharedGroupData)
				->Event("ExecuteCloudScript", &PlayFabCombo_ServerSimpleRequestBus::Events::ExecuteCloudScript)
				->Event("GetContentDownloadUrl", &PlayFabCombo_ServerSimpleRequestBus::Events::GetContentDownloadUrl)
				->Event("DeleteCharacterFromUser", &PlayFabCombo_ServerSimpleRequestBus::Events::DeleteCharacterFromUser)
				->Event("GetAllUsersCharacters", &PlayFabCombo_ServerSimpleRequestBus::Events::GetAllUsersCharacters)
				->Event("GetCharacterLeaderboard", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterLeaderboard)
				->Event("GetCharacterStatistics", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterStatistics)
				->Event("GetLeaderboardAroundCharacter", &PlayFabCombo_ServerSimpleRequestBus::Events::GetLeaderboardAroundCharacter)
				->Event("GetLeaderboardForUserCharacters", &PlayFabCombo_ServerSimpleRequestBus::Events::GetLeaderboardForUserCharacters)
				->Event("GrantCharacterToUser", &PlayFabCombo_ServerSimpleRequestBus::Events::GrantCharacterToUser)
				->Event("UpdateCharacterStatistics", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateCharacterStatistics)
				->Event("GetCharacterData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterData)
				->Event("GetCharacterInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterInternalData)
				->Event("GetCharacterReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::GetCharacterReadOnlyData)
				->Event("UpdateCharacterData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateCharacterData)
				->Event("UpdateCharacterInternalData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateCharacterInternalData)
				->Event("UpdateCharacterReadOnlyData", &PlayFabCombo_ServerSimpleRequestBus::Events::UpdateCharacterReadOnlyData)
				->Event("AddPlayerTag", &PlayFabCombo_ServerSimpleRequestBus::Events::AddPlayerTag)
				->Event("GetAllActionGroups", &PlayFabCombo_ServerSimpleRequestBus::Events::GetAllActionGroups)
				->Event("GetAllSegments", &PlayFabCombo_ServerSimpleRequestBus::Events::GetAllSegments)
				->Event("GetPlayerSegments", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerSegments)
				->Event("GetPlayersInSegment", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayersInSegment)
				->Event("GetPlayerTags", &PlayFabCombo_ServerSimpleRequestBus::Events::GetPlayerTags)
				->Event("RemovePlayerTag", &PlayFabCombo_ServerSimpleRequestBus::Events::RemovePlayerTag)
				->Event("AwardSteamAchievement", &PlayFabCombo_ServerSimpleRequestBus::Events::AwardSteamAchievement);

			// Reflect the ADDRESSED notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabCombo_ServerNotificationBus>("PlayFabServerNotificationBus")
				->Handler<PlayFabCombo_ServerBehaviorBusHandler>();

			// Reflect the GLOBAL notification bus: (uses the BehaviorBusHandler declared at the beginning of this file)
			behaviorContext->EBus<PlayFabCombo_ServerGlobalNotificationBus>("PlayFabServerGlobalNotificationBus")
				->Handler<PlayFabCombo_ServerGlobalBehaviorBusHandler>();                
