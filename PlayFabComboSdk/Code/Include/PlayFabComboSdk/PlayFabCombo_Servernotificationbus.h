...
namespace PlayFabComboSdk
{
    ...
    class PlayFabCombo_ServerNotifications
    ...
    using PlayFabCombo_ServerNotificationBus = AZ::EBus<PlayFabCombo_ServerNotifications>;

    // Global notification bus - use this bus when you want to listen for all responses to a particular type of request. 
    class PlayFabCombo_ServerGlobalNotifications
        : public AZ::EBusTraits
    {
    ...
    using PlayFabCombo_ServerGlobalNotificationBus = AZ::EBus<PlayFabCombo_ServerGlobalNotifications>;
