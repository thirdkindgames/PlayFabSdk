...
namespace PlayFabComboSdk
{
    ...
    inline void PlayFabComboSdk::writeDatetime(time_t datetime, PFStringJsonWriter& writer)
    {
        char buff[40];
    ...
    inline time_t PlayFabComboSdk::readDatetime(const rapidjson::Value& obj)
    {
