...
namespace PlayFabComboSdk
{
    ...
    class PlayFabCombo_ClientNotifications
    ...
    using PlayFabCombo_ClientNotificationBus = AZ::EBus<PlayFabCombo_ClientNotifications>;

    // Global notification bus - use this bus when you want to listen for all responses to a particular type of request. 
    class PlayFabCombo_ClientGlobalNotifications
        : public AZ::EBusTraits
    {
    ...
    using PlayFabCombo_ClientGlobalNotificationBus = AZ::EBus<PlayFabCombo_ClientGlobalNotifications>;
