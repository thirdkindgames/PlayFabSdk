...
namespace PlayFabServerSdk
{
    ...
    class PlayFabServer_AdminSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabServer_AdminSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE2}", CryHooksModule);

        PlayFabServer_AdminSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabServerSdk_a7bd94263453450a8cff6c8d047a82ee, PlayFabServerSdk::PlayFabServer_AdminSdkModule)
