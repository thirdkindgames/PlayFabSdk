...
namespace PlayFabServerSdk
{
    ...
    class PlayFabServer_ServerSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabServer_ServerSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE1}", CryHooksModule);

        PlayFabServer_ServerSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabServerSdk_a7bd94263453450a8cff6c8d047a82ee, PlayFabServerSdk::PlayFabServer_ServerSdkModule)
