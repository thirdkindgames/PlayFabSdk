...
namespace PlayFabServerSdk
{
    ...
    class PlayFabServer_MatchmakerSdkModule
        : public CryHooksModule
    {
    public:
        AZ_RTTI(PlayFabServer_MatchmakerSdkModule, "{FDEEA325-EC4C-4D4B-9FBD-E64A8D523CE3}", CryHooksModule);

        PlayFabServer_MatchmakerSdkModule()
            : CryHooksModule()
        {
...
AZ_DECLARE_MODULE_CLASS(PlayFabServerSdk_a7bd94263453450a8cff6c8d047a82ee, PlayFabServerSdk::PlayFabServer_MatchmakerSdkModule)
